...
/// <summary>
/// This calls the stateful product catalog which is exposed via a proxy service which you access via the service fabric URI
/// this service is used to add or get the products via the stateful ProductCatalog which has its own repo that is initalised 
/// in product catalog using a reliable dictionary 
/// </summary>

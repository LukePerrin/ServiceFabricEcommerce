...
/// <summary>
/// This is using the checkout service which has its own statemanager to store the basket history
/// Checkout service has its own reference to the user/actor and basket service 
/// </summary>
namespace ECommerce.API.Controllers
{
    ...
    public class CheckoutController : ControllerBase
    {
        ...
        public async Task<ApiCheckoutSummary> CheckoutAsync(string userId)
        {
            ...
            return MapApiCheckoutSummary(summary);
        }
           ...
           string userId)
        {
            ...
            return history.Select(MapApiCheckoutSummary);
        }

        /// <summary>
        /// Map our checkout data to a DTO
        /// </summary>
        /// <param name="model"></param>
        /// <returns></returns>
        private ApiCheckoutSummary MapApiCheckoutSummary(CheckoutSummary model)
        {
